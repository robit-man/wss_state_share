...
const INDEX_HTML = [
  ...
  "  <div id=\"menu\">",
  "    <div class=\"row\">",
  "      <button id=\"menuBtn\" class=\"btn icon\" title=\"Expand / collapse menu\">≡</button>",
  ...
  "      if (p.state.q) {",
  "        var q = new THREE.Quaternion(p.state.q.x, p.state.q.y, p.state.q.z, p.state.q.w);",
  "        p.twin.group.quaternion.copy(q);",
  "      }",
